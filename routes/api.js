...
var textto = require('soundoftext-js');
...
router.get('/downloader/ttmp3', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    danzz.ttaud(url)
      .then(data => {
        if (!data.audio) return res.json(mess.noturl)
        var result = data
        res.json({
          status: true,
          author: `${author}`,
...
router.get('/downloader/ttmp4', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    danzz.ttvid(url)
      .then(data => {
        if (!data.video) return res.json(mess.noturl)
        var result = data
        res.json({
          status: true,
          author: `${author}`,
...
router.get('/cogan/random', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/cogan/random.json`))
...
router.get('/search/youtube', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    fetch(encodeURI(`https://danzz-apiv3.up.railway.app/api/search/youtube?query=${query}&apikey=danzz`))
      .then(response => response.json())
      .then(hasil => {
...
router.get('/sfw/waifu', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/sfw/waifu.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/sfw/husbu', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/sfw/husbu.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/sfw/loli', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/sfw/loli.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/sfw/milf', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/sfw/milf.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/sfw/neko', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/sfw/neko.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/sfw/shota', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/sfw/shota.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/nsfw/glasses', async (req, res, next) => {
  ...
  if (listkeyprem.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/nsfw/glasses.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/nsfw/gangbang', async (req, res, next) => {
  ...
  if (listkeyprem.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/nsfw/gangbang.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/nsfw/manga', async (req, res, next) => {
  ...
  if (listkeyprem.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/nsfw/manga.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/nsfw/masturbation', async (req, res, next) => {
  ...
  if (listkeyprem.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/nsfw/masturbation.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/nsfw/ass', async (req, res, next) => {
  ...
  if (listkeyprem.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/nsfw/ass.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/nsfw/eba', async (req, res, next) => {
  ...
  if (listkeyprem.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/nsfw/eba.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/nsfw/thighs', async (req, res, next) => {
  ...
  if (listkeyprem.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/nsfw/thighs.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/nsfw/zettai', async (req, res, next) => {
  ...
  if (listkeyprem.includes(apikey)) {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/nsfw/zettai.json`))
      .then(response => response.json())
      .then(async data => {
        var result = data[Math.floor(Math.random() * data.length)];
        var buffer = result.url;
...
router.get('/random/katakasar', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson('https://raw.githubusercontent.com/Danzzxcodes/scraper/main/fun/katakasar.json')
    var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/random/dadu', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let dadu = await fetchJson('https://raw.githubusercontent.com/Danzzxcodes/scraper/main/random_image/dadu.json')
...
router.get('/islamic/randomimage', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson(`https://github.com/candrafl/data-api/blob/main/islamic/random_img.json`)
...
router.get('/islamic/kisahnabi', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson(`https://github.com/candrafl/data-api/tree/main/islamic/kisah_nabi/${name}.json`)
    res.json({
      status: true,
      author: `${author}`,
      result: data
...
router.get('/islamic/asmaulhusna', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson(`https://github.com/candrafl/data-api/blob/main/islamic/asmaul_husna.json`)
    res.json({
      status: true,
      author: `${author}`,
      result: data
...
router.get('/islamic/hadist', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson(`https://api.lolhuman.xyz/api/hadits/search?apikey=f9d670760238829bbaf0197d&query=${query}`)
...
router.get('/islamic/quran', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson(`https://github.com/candrafl/data-api/blob/main/islamic/quran.json`)
    res.json({
      status: true,
      author: `${author}`,
      result: data
...
router.get('/news/inews', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson(`https://api.zahwazein.xyz/news/inews?apikey=872688fc02`)
    if (!data.result) return res.sendFile(__path + '/views/error.html')
...
router.get('/news/okezone', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson(`https://api.zahwazein.xyz/news/okezone?apikey=872688fc02`)
    if (!data.result) return res.sendFile(__path + '/views/error.html')
...
router.get('/news/antara', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson(`https://api.zahwazein.xyz/news/antaranews?apikey=sonelstore`)
    if (!data.result) return res.sendFile(__path + '/views/error.html')
...
router.get('/information/covidworld', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson(`https://api.zahwazein.xyz/information/covidworld?apikey=sonelstore`)
    if (!data.result) return res.sendFile(__path + '/views/error.html')
...
router.get('/information/jadwalbola', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson(`https://api.lolhuman.xyz/api/jadwalbola?apikey=f9d670760238829bbaf0197d`)
...
router.get('/information/wikipedia', async (req, res, next) => {
  ...
  let data = await fetchJson(`https://api.zahwazein.xyz/information/wikipedia?query=${query}&apikey=sonelstore`)
  if (!data.result) return res.sendFile(__path + '/views/error.html')
...
router.get('/primbon/tafsirmimpi', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson(`https://api.zahwazein.xyz/primbon/artimimpi?query=${dream}&apikey=sonelstore`)
...
router.get('/tools/fakeaddress', async (req, res, next) => {
  ...
  if (listkey.includes(apikey)) {
    ...
    let data = await fetchJson(`https://github.com/candrafl/data-api/blob/main/tools/fake_address.json`)
    res.json({
      status: true,
      author: `${author}`,
      result: data
